...
namespace PGI\Impact\PGWooCommerce\Services\Linkers;

use WC_Order as LocalWC_Order;
use PGI\Impact\PGWooCommerce\Foundations\Linkers\AbstractOrderLinker;
use Exception;
...
class OrderLinker extends AbstractOrderLinker
{
    ...
    public function buildUrl(array $data = array())
    {
        ...
        return $localOrder->get_view_order_url();
    }
}
