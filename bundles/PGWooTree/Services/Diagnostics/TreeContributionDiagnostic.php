...
namespace PGI\Impact\PGWooTree\Services\Diagnostics;
 ...
 * @package PGWooTree\Services\Diagnostics
 */
class TreeContributionDiagnostic extends AbstractDiagnostic
{
    ...
    public function isValid()
    {
        if (!$this->isDiagnosticAvailable()) {
            $this->logger->warning("TreeContributionDiagnostic diagnostic is not available.");
            return true;
        }
