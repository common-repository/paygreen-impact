...
{
    const TEMPLATE_NAME = 'page-pgimpact-frontoffice.php';

    public function filter($page_template)
    {
        $isPayGreenRequest = (isset($_GET['pgiaction']) || isset($_POST['pgiaction']));
        ...
        if (is_front_page() && $isPayGreenRequest) {
            ...
            if (file_exists(get_stylesheet_directory() . DS . 'woocommerce' . DS . self::TEMPLATE_NAME)) {
                ...
                $page_template = PGIMPACT_MODULE_DIR . DS . self::TEMPLATE_NAME;
            }
